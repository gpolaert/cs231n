...
class TwoLayerNet(object):
    ...
    def __init__(self, input_dim=3 * 32 * 32, hidden_dim=100, num_classes=10,
        ...
        self.params['W2'] = weight_scale * np.random.randn(hidden_dim, num_classes) + 0
    ...
    def loss(self, X, y=None):
        ...
        scores, cache3 = affine_forward(layer2, W2, b2)
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        ############################################################################
        loss, dlayer3 = softmax_loss(scores, y)
        loss += 0.5 * self.reg * (np.sum(W1 * W1) + np.sum(W2 * W2))

        dlayer2, dW2, db2 = affine_backward(dlayer3, cache3)
...
class FullyConnectedNet(object):
    ...
    def loss(self, X, y=None):
        ...
        scores, caches[self.num_layers] = affine_forward(inputs[self.num_layers - 1], W, b)
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
